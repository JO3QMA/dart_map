...
export default function App() {
  ...
  const handleThrow = useCallback(async () => {
    ...
    try {
      ...
      const selected = await fetchRandomTarget(mode, parentId, mergeDesignatedCities)

      let parentForResult: string | undefined = resolveParentName()
      if (mode === 'city' && selected.type === 'town' && selected.parentId && selectedPrefecture) {
  ...
  }, [isAnimating, mode, getParentId, resolveParentName, selectedPrefecture, mergeDesignatedCities])
